...
8010485c:	83 fa 15             	cmp    $0x15,%edx
8010485f:	77 1f                	ja     80104880 <syscall+0x40>
80104861:	8b 14 85 c0 75 10 80 	mov    -0x7fef8a40(,%eax,4),%edx
...
80104888:	68 91 75 10 80       	push   $0x80107591
...
801048a4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
	  readcount++;
801048a8:	83 05 bc a5 10 80 01 	addl   $0x1,0x8010a5bc
  if(num > 0 && num < NELEM(syscalls) && syscalls[num]) {
...
80105651:	a1 bc a5 10 80       	mov    0x8010a5bc,%eax
{
